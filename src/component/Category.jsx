...
const Category = () => {
  ...
  return (
    <div className="products-section flex flex-col items-center p-3 lg:p-10">
      ...
      <div className="flex space-x-4 mb-7">
        {categories.map((category) => (
          <span
            key={category}
            className={`bg-none border-none cursor-pointer ${selectedCategory === category ? 'text-brandBrown' : ''} text-sm font-medium`}
      ...
      {isLoading && (
        <div className="flex items-center justify-center">
          <div role="status">
            <svg
              className="w-8 h-8 animate-spin text-brandBrown fill-current"
              viewBox="0 0 100 101"
              fill="none"
