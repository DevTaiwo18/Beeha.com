      ...
      >
        <SwiperSlide>
          <div className="swiper-slide-content">
            <img src={image1} alt="Slide 1" className="swiper-slide-image" />
        ...
        <SwiperSlide>
          <div className="swiper-slide-content">
            <img src={image2} alt="Slide 2" className="swiper-slide-image" />
            <div className="slider_content">
        ...
        <SwiperSlide>
          <div className="swiper-slide-content">
            <img src={image3} alt="Slide 3" className="swiper-slide-image w-full h-full object-cover" />
            <div className="slider_content">
